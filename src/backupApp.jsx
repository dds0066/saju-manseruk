...
import { Calendar, Star, Sparkles, Moon, Sun, Heart, TrendingUp, Shield, Zap, Book } from 'lucide-react';
    ...
    setTimeout(() => {
      try {
        ...
        const elementBalance = {
          목: [saju.yearStem, saju.monthStem, saju.dayStem, saju.hourStem].filter(s => saju.getElement(s) === '목').length,
          화: [saju.yearStem, saju.monthStem, saju.dayStem, saju.hourStem].filter(s => saju.getElement(s) === '화').length,
          토: [saju.yearStem, saju.monthStem, saju.dayStem, saju.hourStem].filter(s => saju.getElement(s) === '토').length,
          금: [saju.yearStem, saju.monthStem, saju.dayStem, saju.hourStem].filter(s => saju.getElement(s) === '금').length,
          수: [saju.yearStem, saju.monthStem, saju.dayStem, saju.hourStem].filter(s => saju.getElement(s) === '수').length
        };
